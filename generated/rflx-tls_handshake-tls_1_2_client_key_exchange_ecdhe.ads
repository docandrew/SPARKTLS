...
package RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   type Virtual_Field is (F_Initial, F_Point_Length, F_Point, F_Final);

   subtype Field is Virtual_Field range F_Point_Length .. F_Point;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Well_Formed_Message (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then Offset < RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Buffer_Length (Ctx)
       and then Pre (RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Point =>
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, Fld);
   ...
   function Get_Point_Length (Ctx : Context) return RFLX.TLS_Handshake.TLS_1_2_CKE_Point_Length
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point_Length);
   ...
   with
     ...
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Well_Formed (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point),
     Post =>
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Well_Formed (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then Data'Length = RFLX_Types.To_Length (RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)),
     Post =>
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Present (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point);
   ...
   procedure Set_Point_Length (Ctx : in out Context; Val : RFLX.TLS_Handshake.TLS_1_2_CKE_Point_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point_Length)
       and then RFLX.TLS_Handshake.Valid_TLS_1_2_CKE_Point_Length (RFLX.TLS_Handshake.To_Base_Integer (Val))
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point_Length) >= RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point_Length)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point) >= RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point),
     Post =>
       Has_Buffer (Ctx)
       and then Well_Formed (Ctx, F_Point)
       and then (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Point))
       and then Ctx.Buffer_First = Ctx.Buffer_First'Old
       and then Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and then Ctx.First = Ctx.First'Old
       and then Ctx.Last = Ctx.Last'Old
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point) >= RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point, Data'Length)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Point)
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Point))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point) >= RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point, Length)
       and then RFLX_Types.To_Length (RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point)) >= Length
   ...
   type Structure is
      record
         Point_Length : RFLX.TLS_Handshake.TLS_1_2_CKE_Point_Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Structure (Struct)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Point_Length)) then True)
      ...
      and then ((if
                 ...
                 then
                    (Cursors (F_Point_Length).Last - Cursors (F_Point_Length).First + 1 = 8
                     and then Cursors (F_Point_Length).First = First))
                and then (if
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      and then Valid_Next (Ctx, F_Point_Length)
      and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_First (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point_Length) rem RFLX_Types.Byte'Size = 1
      and then Available_Space (Ctx, F_Point_Length) = Ctx.Last - Ctx.First + 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Point_Length =>
             RFLX.TLS_Handshake.Valid_TLS_1_2_CKE_Point_Length (Val),
          when F_Point =>
             True);

   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     (case Fld is
          when F_Point_Length | F_Point =>
             True);
   ...
   function Get_Point_Length (Ctx : Context) return RFLX.TLS_Handshake.TLS_1_2_CKE_Point_Length is
   ...
   function Sufficient_Buffer_Length (Ctx : Context; Struct : Structure) return Boolean is
     (RFLX_Types.Base_Integer (RFLX_Types.To_Last_Bit_Index (Ctx.Buffer_Last) - RFLX_Types.To_First_Bit_Index (Ctx.Buffer_First) + 1) >= RFLX_Types.Base_Integer (Struct.Point_Length) * 8 + 8);
...
end RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE;
