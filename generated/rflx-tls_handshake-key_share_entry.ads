...
package RFLX.TLS_Handshake.Key_Share_Entry
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   type Virtual_Field is (F_Initial, F_Group, F_Length, F_Key_Exchange, F_Final);
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Well_Formed_Message (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       ...
       and then Offset < RFLX.TLS_Handshake.Key_Share_Entry.Buffer_Length (Ctx)
       and then Pre (RFLX.TLS_Handshake.Key_Share_Entry.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.TLS_Handshake.Key_Share_Entry.Byte_Size (Ctx);
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_Entry.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   function Get_Group (Ctx : Context) return RFLX.Tls_Parameters.TLS_Supported_Groups
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_Entry.Valid (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Group);

   function Get_Length (Ctx : Context) return RFLX.TLS_Handshake.Key_Exchange_Length
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_Entry.Valid (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Length);
   ...
   with
     ...
     Pre =>
       RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Well_Formed (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_Entry.Well_Formed (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)
       and then Data'Length = RFLX_Types.To_Length (RFLX.TLS_Handshake.Key_Share_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)),
     Post =>
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.Key_Share_Entry.Present (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange);
   ...
   procedure Set_Group (Ctx : in out Context; Val : RFLX.Tls_Parameters.TLS_Supported_Groups_Enum)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.TLS_Handshake.Key_Exchange_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Length)
       and then RFLX.TLS_Handshake.Valid_Key_Exchange_Length (RFLX.TLS_Handshake.To_Base_Integer (Val))
       and then RFLX.TLS_Handshake.Key_Share_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Length) >= RFLX.TLS_Handshake.Key_Share_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Length)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Field_Condition (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange) >= RFLX.TLS_Handshake.Key_Share_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange) >= RFLX.TLS_Handshake.Key_Share_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Valid_Length (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange, Data'Length)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.TLS_Handshake.Key_Share_Entry.Field_Condition (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Key_Exchange),
     Post =>
       Has_Buffer (Ctx)
   ...
   type Structure is
      record
         Group : RFLX.Tls_Parameters.TLS_Supported_Groups;
         Length : RFLX.TLS_Handshake.Key_Exchange_Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Key_Share_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Valid_Structure (Struct)
       and then RFLX.TLS_Handshake.Key_Share_Entry.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Group)) then True)
      and then (if Well_Formed (Cursors (F_Length)) then Valid (Cursors (F_Group)))
      and then (if Well_Formed (Cursors (F_Key_Exchange)) then Valid (Cursors (F_Length))))
   with
     Pre =>
                ...
                and then (if
                          ...
                          then
                             (Cursors (F_Length).Last - Cursors (F_Length).First + 1 = 16
                              and then Cursors (F_Length).First = Cursors (F_Group).Last + 1))
                and then (if
                             Well_Formed (Cursors (F_Key_Exchange))
                          then
                             (Cursors (F_Key_Exchange).Last - Cursors (F_Key_Exchange).First + 1 = RFLX_Types.Bit_Length (Cursors (F_Length).Value) * 8
                              and then Cursors (F_Key_Exchange).First = Cursors (F_Length).Last + 1))))
   with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.TLS_Handshake.Key_Share_Entry.Field_First (Ctx, RFLX.TLS_Handshake.Key_Share_Entry.F_Group) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          ...
          when F_Length =>
             RFLX.TLS_Handshake.Valid_Key_Exchange_Length (Val),
          when F_Key_Exchange =>
             True);

   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     (case Fld is
          when F_Group | F_Length | F_Key_Exchange =>
             True);
   ...
   function Get_Group (Ctx : Context) return RFLX.Tls_Parameters.TLS_Supported_Groups is
     (To_Actual (Ctx.Cursors (F_Group).Value));

   function Get_Length (Ctx : Context) return RFLX.TLS_Handshake.Key_Exchange_Length is
   ...
   function Valid_Structure (Struct : Structure) return Boolean is
     (RFLX.Tls_Parameters.Valid_TLS_Supported_Groups (Struct.Group));

   function Sufficient_Buffer_Length (Ctx : Context; Struct : Structure) return Boolean is
     (RFLX_Types.Base_Integer (RFLX_Types.To_Last_Bit_Index (Ctx.Buffer_Last) - RFLX_Types.To_First_Bit_Index (Ctx.Buffer_First) + 1) >= RFLX_Types.Base_Integer (Struct.Length) * 8 + 32);
