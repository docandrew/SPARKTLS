...
package body RFLX.TLS_Handshake.Supported_Version
with
  SPARK_Mode
is
   ...
   with
     Pre =>
       ...
       and RFLX.TLS_Handshake.Supported_Version.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Supported_Version.Sufficient_Buffer_Length (Ctx, Fld)
   is
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Supported_Version.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Supported_Version.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.Supported_Version.Valid_Value (Fld, Val)
       and then RFLX.TLS_Handshake.Supported_Version.Valid_Size (Ctx, Fld, Size)
       and then Size <= RFLX.TLS_Handshake.Supported_Version.Available_Space (Ctx, Fld)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Supported_Version.Valid_Next (Ctx, Fld)
       and then Fld in F_Version
       and then RFLX.TLS_Handshake.Supported_Version.Valid_Value (Fld, Val)
       and then RFLX.TLS_Handshake.Supported_Version.Valid_Size (Ctx, Fld, RFLX.TLS_Handshake.Supported_Version.Field_Size (Ctx, Fld))
       and then RFLX.TLS_Handshake.Supported_Version.Available_Space (Ctx, Fld) >= RFLX.TLS_Handshake.Supported_Version.Field_Size (Ctx, Fld)
       and then RFLX.TLS_Handshake.Supported_Version.Field_Size (Ctx, Fld) in 1 .. RFLX_Types.Base_Integer'Size
       and then RFLX_Types.Fits_Into (Val, Natural (RFLX.TLS_Handshake.Supported_Version.Field_Size (Ctx, Fld))),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, Fld)
   ...
   procedure Set_Version (Ctx : in out Context; Val : RFLX.TLS_Common.Protocol_Version) is
   begin
      Set_Scalar (Ctx, F_Version, RFLX.TLS_Common.To_Base_Integer (Val));
   end Set_Version;
