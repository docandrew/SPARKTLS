...
package RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   type Virtual_Field is (F_Initial, F_Cert_Data_Length, F_Cert_Data, F_Final);

   subtype Field is Virtual_Field range F_Cert_Data_Length .. F_Cert_Data;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Well_Formed_Message (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then Offset < RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Buffer_Length (Ctx)
       and then Pre (RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Cert_Data =>
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, Fld);
   ...
   function Get_Cert_Data_Length (Ctx : Context) return RFLX.TLS_Handshake.TLS_1_2_Cert_Entry_Length
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data_Length);
   ...
   with
     ...
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Well_Formed (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data),
     Post =>
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Well_Formed (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then Data'Length = RFLX_Types.To_Length (RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)),
     Post =>
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Present (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data);
   ...
   procedure Set_Cert_Data_Length (Ctx : in out Context; Val : RFLX.TLS_Handshake.TLS_1_2_Cert_Entry_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data_Length)
       and then RFLX.TLS_Handshake.Valid_TLS_1_2_Cert_Entry_Length (RFLX.TLS_Handshake.To_Base_Integer (Val))
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data_Length) >= RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data_Length)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data) >= RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data),
     Post =>
       Has_Buffer (Ctx)
       and then Well_Formed (Ctx, F_Cert_Data)
       and then (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Cert_Data))
       and then Ctx.Buffer_First = Ctx.Buffer_First'Old
       and then Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and then Ctx.First = Ctx.First'Old
       and then Ctx.Last = Ctx.Last'Old
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data) >= RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data, Data'Length)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Cert_Data)
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Cert_Data))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data) >= RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data, Length)
       and then RFLX_Types.To_Length (RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data)) >= Length
   ...
   type Structure is
      record
         Cert_Data_Length : RFLX.TLS_Handshake.TLS_1_2_Cert_Entry_Length;
         Cert_Data : RFLX_Types.Bytes (RFLX_Types.Index'First .. RFLX_Types.Index'First + 16777214);
      end record;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Structure (Struct)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
   ...
   function Field_Size_Cert_Data_Length (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);

   function Field_Size_Cert_Data (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_First (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data_Length) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Cert_Data_Length =>
             RFLX.TLS_Handshake.Valid_TLS_1_2_Cert_Entry_Length (Val),
          when F_Cert_Data =>
             True);

   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     (case Fld is
          when F_Cert_Data_Length | F_Cert_Data =>
             True);
   ...
   function Well_Formed_Message (Ctx : Context) return Boolean is
     (Well_Formed (Ctx, F_Cert_Data));

   function Valid_Message (Ctx : Context) return Boolean is
     (Valid (Ctx, F_Cert_Data));

   function Incomplete_Message (Ctx : Context) return Boolean is
     ((for some F in Field =>
          Incomplete (Ctx, F)));

   function Get_Cert_Data_Length (Ctx : Context) return RFLX.TLS_Handshake.TLS_1_2_Cert_Entry_Length is
   ...
   function Sufficient_Buffer_Length (Ctx : Context; Struct : Structure) return Boolean is
     (RFLX_Types.Base_Integer (RFLX_Types.To_Last_Bit_Index (Ctx.Buffer_Last) - RFLX_Types.To_First_Bit_Index (Ctx.Buffer_First) + 1) >= RFLX_Types.Base_Integer (Struct.Cert_Data_Length) * 8 + 24);

   function Field_Size_Cert_Data_Length (Struct : Structure) return RFLX_Types.Bit_Length is
     (24);

   function Field_Size_Cert_Data (Struct : Structure) return RFLX_Types.Bit_Length is
     (RFLX_Types.Bit_Length (Struct.Cert_Data_Length) * 8);

end RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry;
