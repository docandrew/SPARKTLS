...
is
   ...
   with
     ...
     Pre =>
       ...
       and then RFLX.TLS_Handshake.SH_Extension_TLS.Field_Condition (Ctx, RFLX.TLS_Handshake.SH_Extension_TLS.F_Tag),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Tag)
   ...
   with
     ...
     Pre =>
       ...
       and then RFLX.TLS_Handshake.SH_Extension_TLS.Field_Condition (Ctx, RFLX.TLS_Handshake.SH_Extension_TLS.F_Data_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.SH_Extension_TLS.Field_Condition (Ctx, RFLX.TLS_Handshake.SH_Extension_TLS.F_Data)
