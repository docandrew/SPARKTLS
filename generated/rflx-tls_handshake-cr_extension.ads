------------------------------------------------------------------------------
--                                                                          --
--               Generated by RecordFlux 0.26.0 on 2026-09-15               --
--                                                                          --
...
is
   ...
   with
     ...
     Pre =>
       ...
       and then RFLX.TLS_Handshake.CR_Extension.Field_Condition (Ctx, RFLX.TLS_Handshake.CR_Extension.F_Tag),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Tag)
   ...
   with
     ...
     Pre =>
       ...
       and then RFLX.TLS_Handshake.CR_Extension.Field_Condition (Ctx, RFLX.TLS_Handshake.CR_Extension.F_Data_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.CR_Extension.Field_Condition (Ctx, RFLX.TLS_Handshake.CR_Extension.F_Data)
