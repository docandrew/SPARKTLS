...
package RFLX.TLS_Handshake.Key_Share_SH
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Well_Formed_Message (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       ...
       and then Offset < RFLX.TLS_Handshake.Key_Share_SH.Buffer_Length (Ctx)
       and then Pre (RFLX.TLS_Handshake.Key_Share_SH.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.TLS_Handshake.Key_Share_SH.Byte_Size (Ctx);
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_SH.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_SH.Valid (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Group);

   function Get_Length (Ctx : Context) return RFLX.TLS_Handshake.Key_Exchange_Length
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_SH.Valid (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Length);
   ...
   with
     ...
     Pre =>
       RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Well_Formed (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_SH.Well_Formed (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_SH.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)
       and then Data'Length = RFLX_Types.To_Length (RFLX.TLS_Handshake.Key_Share_SH.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)),
     Post =>
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.Key_Share_SH.Present (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Length)
       and then RFLX.TLS_Handshake.Valid_Key_Exchange_Length (RFLX.TLS_Handshake.To_Base_Integer (Val))
       and then RFLX.TLS_Handshake.Key_Share_SH.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Length) >= RFLX.TLS_Handshake.Key_Share_SH.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Length)
       and then RFLX.TLS_Handshake.Key_Share_SH.Field_Condition (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_SH.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange) >= RFLX.TLS_Handshake.Key_Share_SH.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.Key_Share_SH.Valid_Next (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_SH.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange) >= RFLX.TLS_Handshake.Key_Share_SH.Field_Size (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange)
       and then RFLX.TLS_Handshake.Key_Share_SH.Valid_Length (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange, Data'Length)
       and then RFLX.TLS_Handshake.Key_Share_SH.Available_Space (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.TLS_Handshake.Key_Share_SH.Field_Condition (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Key_Exchange),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Key_Share_SH.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Key_Share_SH.Valid_Structure (Struct)
       and then RFLX.TLS_Handshake.Key_Share_SH.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.TLS_Handshake.Key_Share_SH.Field_First (Ctx, RFLX.TLS_Handshake.Key_Share_SH.F_Group) rem RFLX_Types.Byte'Size = 1
