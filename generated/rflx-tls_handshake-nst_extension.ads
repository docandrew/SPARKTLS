...
is
   ...
   with
     ...
     Pre =>
       ...
       and then RFLX.TLS_Handshake.NST_Extension.Field_Condition (Ctx, RFLX.TLS_Handshake.NST_Extension.F_Tag),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Tag)
   ...
   with
     ...
     Pre =>
       ...
       and then RFLX.TLS_Handshake.NST_Extension.Field_Condition (Ctx, RFLX.TLS_Handshake.NST_Extension.F_Data_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.NST_Extension.Field_Condition (Ctx, RFLX.TLS_Handshake.NST_Extension.F_Data)
