...
package RFLX.TLS_Handshake.Cipher_Suite_TLS
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Well_Formed_Message (Ctx)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx)
       and then Offset < RFLX.TLS_Handshake.Cipher_Suite_TLS.Buffer_Length (Ctx)
       and then Pre (RFLX.TLS_Handshake.Cipher_Suite_TLS.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.TLS_Handshake.Cipher_Suite_TLS.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Cipher_Suite_TLS.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.Cipher_Suite_TLS.Valid (Ctx, RFLX.TLS_Handshake.Cipher_Suite_TLS.F_Suite);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Valid_Next (Ctx, RFLX.TLS_Handshake.Cipher_Suite_TLS.F_Suite)
       and then RFLX.Tls_Parameters.Valid_TLS_Cipher_Suites (RFLX.Tls_Parameters.To_Base_Integer (Val))
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Available_Space (Ctx, RFLX.TLS_Handshake.Cipher_Suite_TLS.F_Suite) >= RFLX.TLS_Handshake.Cipher_Suite_TLS.Field_Size (Ctx, RFLX.TLS_Handshake.Cipher_Suite_TLS.F_Suite)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Field_Condition (Ctx, RFLX.TLS_Handshake.Cipher_Suite_TLS.F_Suite),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Valid_Structure (Struct)
       and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.TLS_Handshake.Cipher_Suite_TLS.Field_First (Ctx, RFLX.TLS_Handshake.Cipher_Suite_TLS.F_Suite) rem RFLX_Types.Byte'Size = 1
...
end RFLX.TLS_Handshake.Cipher_Suite_TLS;
