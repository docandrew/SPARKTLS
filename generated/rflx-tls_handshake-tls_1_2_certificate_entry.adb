...
package body RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry
with
  SPARK_Mode
is
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Sufficient_Buffer_Length (Ctx, Fld)
       and then not RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Composite_Field (Fld)
   is
   ...
   begin
      ...
      then
         if Sufficient_Buffer_Length (Ctx, Fld) then
            ...
            then
               pragma Assert (if Fld = F_Cert_Data then Field_Last (Ctx, Fld) mod RFLX_Types.Byte'Size = 0);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Value (Fld, Val)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Size (Ctx, Fld, Size)
       and then Size <= RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, Fld)
       and then (if
                    RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Composite_Field (Fld)
                 then
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Next (Ctx, Fld)
       and then Fld in F_Cert_Data_Length
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Value (Fld, Val)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Size (Ctx, Fld, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, Fld))
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Available_Space (Ctx, Fld) >= RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, Fld) in 1 .. RFLX_Types.Base_Integer'Size
       and then RFLX_Types.Fits_Into (Val, Natural (RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Field_Size (Ctx, Fld))),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, Fld)
   ...
   procedure Set_Cert_Data_Length (Ctx : in out Context; Val : RFLX.TLS_Handshake.TLS_1_2_Cert_Entry_Length) is
   begin
   ...
   begin
      ...
      pragma Assert (RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entry.F_Cert_Data, Length));
   ...
   begin
      Struct.Cert_Data_Length := Get_Cert_Data_Length (Ctx);
      Struct.Cert_Data := (others => 0);
      Get_Cert_Data (Ctx, Struct.Cert_Data (Struct.Cert_Data'First .. Struct.Cert_Data'First + RFLX_Types.Index (RFLX_Types.To_Length (Field_Size (Ctx, F_Cert_Data)) + 1) - 2));
   end To_Structure;

   procedure To_Context (Struct : Structure; Ctx : in out Context) is
   begin
      Reset (Ctx);
      Set_Cert_Data_Length (Ctx, Struct.Cert_Data_Length);
      Set_Cert_Data (Ctx, Struct.Cert_Data (Struct.Cert_Data'First .. Struct.Cert_Data'First + RFLX_Types.Index (RFLX_Types.To_Length (RFLX_Types.Bit_Length (Struct.Cert_Data_Length) * 8) + 1) - 2));
   end To_Context;
