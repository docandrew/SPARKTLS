...
package RFLX.TLS_Handshake.TLS_1_2_Certificate
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   type Virtual_Field is (F_Initial, F_Certificate_List_Length, F_Certificate_List, F_Final);

   subtype Field is Virtual_Field range F_Certificate_List_Length .. F_Certificate_List;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Well_Formed_Message (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then Offset < RFLX.TLS_Handshake.TLS_1_2_Certificate.Buffer_Length (Ctx)
       and then Pre (RFLX.TLS_Handshake.TLS_1_2_Certificate.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Well_Formed_Message (Ctx)
       and then Data'Length = RFLX.TLS_Handshake.TLS_1_2_Certificate.Byte_Size (Ctx);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, Fld);
   ...
   function Get_Certificate_List_Length (Ctx : Context) return RFLX.TLS_Handshake.TLS_1_2_Cert_List_Length
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List_Length);
   ...
   procedure Set_Certificate_List_Length (Ctx : in out Context; Val : RFLX.TLS_Handshake.TLS_1_2_Cert_List_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List_Length)
       and then RFLX.TLS_Handshake.Valid_TLS_1_2_Cert_List_Length (RFLX.TLS_Handshake.To_Base_Integer (Val))
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List_Length) >= RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List_Length)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List) >= RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Certificate_List (Ctx : in out Context; Seq_Ctx : RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List) >= RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List, RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Byte_Size (Seq_Ctx))
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Has_Buffer (Seq_Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Valid (Seq_Ctx),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Certificate_List)
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Certificate_List))
   ...
   procedure Switch_To_Certificate_List (Ctx : in out Context; Seq_Ctx : out RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Context)
   with
     Pre =>
       not Ctx'Constrained
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List) > 0
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_First (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List) rem RFLX_Types.Byte'Size = 1
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Available_Space (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List) >= RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Size (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_Condition (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List),
     Post =>
       not RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Has_Buffer (Seq_Ctx)
       ...
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Valid (Seq_Ctx)
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Sequence_Last (Seq_Ctx) = Seq_Ctx.First - 1
       ...
       and (for all F in Field range F_Certificate_List_Length .. F_Certificate_List_Length =>
   ...
   function Complete_Certificate_List (Ctx : Context; Seq_Ctx : RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Context) return Boolean
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Valid_Next (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List);

   procedure Update_Certificate_List (Ctx : in out Context; Seq_Ctx : in out RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Context)
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Certificate.Present (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List)
       and then not RFLX.TLS_Handshake.TLS_1_2_Certificate.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Has_Buffer (Seq_Ctx)
     ...
     Post =>
       (if
           RFLX.TLS_Handshake.TLS_1_2_Certificate.Complete_Certificate_List (Ctx, Seq_Ctx)
        then
           Present (Ctx, F_Certificate_List)
        else
           Invalid (Ctx, F_Certificate_List))
       and Has_Buffer (Ctx)
       and not RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Has_Buffer (Seq_Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       ...
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Valid (Seq_Ctx) = RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Valid (Seq_Ctx)'Old
       and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Size (Seq_Ctx) = RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Size (Seq_Ctx)'Old
       and Field_First (Ctx, F_Certificate_List) = Field_First (Ctx, F_Certificate_List)'Old
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Certificate_List_Length)) then True)
      ...
      and then ((if
                 ...
                 then
                    (Cursors (F_Certificate_List_Length).Last - Cursors (F_Certificate_List_Length).First + 1 = 24
                     and then Cursors (F_Certificate_List_Length).First = First))
                and then (if
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.TLS_Handshake.TLS_1_2_Certificate.Field_First (Ctx, RFLX.TLS_Handshake.TLS_1_2_Certificate.F_Certificate_List_Length) rem RFLX_Types.Byte'Size = 1
      and then Available_Space (Ctx, F_Certificate_List_Length) = Ctx.Last - Ctx.First + 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Certificate_List_Length =>
             RFLX.TLS_Handshake.Valid_TLS_1_2_Cert_List_Length (Val),
          when F_Certificate_List =>
             True);

   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     (case Fld is
          when F_Certificate_List_Length | F_Certificate_List =>
             True);
   ...
   function Get_Certificate_List_Length (Ctx : Context) return RFLX.TLS_Handshake.TLS_1_2_Cert_List_Length is
   ...
   function Complete_Certificate_List (Ctx : Context; Seq_Ctx : RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Context) return Boolean is
     (RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Valid (Seq_Ctx)
      and RFLX.TLS_Handshake.TLS_1_2_Certificate_Entries.Size (Seq_Ctx) = Field_Size (Ctx, F_Certificate_List));
...
end RFLX.TLS_Handshake.TLS_1_2_Certificate;
