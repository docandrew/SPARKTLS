...
package body RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE
with
  SPARK_Mode
is
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Sufficient_Buffer_Length (Ctx, Fld)
       and then not RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Composite_Field (Fld)
   is
   ...
   begin
      ...
      then
         if Sufficient_Buffer_Length (Ctx, Fld) then
            ...
            then
               pragma Assert (if Fld = F_Point then Field_Last (Ctx, Fld) mod RFLX_Types.Byte'Size = 0);
   ...
   with
     Pre =>
       RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Has_Buffer (Ctx)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Value (Fld, Val)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Size (Ctx, Fld, Size)
       and then Size <= RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, Fld)
       and then (if
                    RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Composite_Field (Fld)
                 then
     ...
     Post =>
       ...
       and then (Ctx.Cursors (Fld).Value = Val
                 and then (if Fld in F_Point and then Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, Fld)))
   ...
   with
     Pre =>
       ...
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Next (Ctx, Fld)
       and then Fld in F_Point_Length
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Value (Fld, Val)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Size (Ctx, Fld, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, Fld))
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Available_Space (Ctx, Fld) >= RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, Fld)
       and then RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, Fld) in 1 .. RFLX_Types.Base_Integer'Size
       and then RFLX_Types.Fits_Into (Val, Natural (RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Field_Size (Ctx, Fld))),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, Fld)
   ...
   procedure Set_Point_Length (Ctx : in out Context; Val : RFLX.TLS_Handshake.TLS_1_2_CKE_Point_Length) is
   begin
   ...
   begin
      ...
      pragma Assert (RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.Valid_Length (Ctx, RFLX.TLS_Handshake.TLS_1_2_Client_Key_Exchange_ECDHE.F_Point, Length));
