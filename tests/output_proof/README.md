...
accepted prefix advances the cursor.
An over-reported count fails the session (Error_State, Internal_Error) and
consumes nothing, even with contracts disabled.
...
zero progress, partial accepts, buffer reuse, both roles, all cipher
