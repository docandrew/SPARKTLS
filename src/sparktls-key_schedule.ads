...
is
   ...
   with
     Pre =>
       Finished_Key'First = 0
       and Finished_Key'Last = 31
   ...
   procedure Derive_PSK (PSK : out OKM_Seq; Res_Master : in Byte_Seq; Nonce : in Byte_Seq)
   with
     Pre =>
       PSK'First = 0
       and PSK'Last = 31
       and Res_Master'First = 0
       and Res_Master'Last = 31
       and Nonce'First = 0
       and Nonce'Length > 0
   ...
   procedure Derive_Binder_Key (Binder_Key : out OKM_Seq; PSK : in Bytes_32)
   ...
   procedure Derive_Early_Secret_384 (Early : out Digest_384; PSK : in Bytes_48);
   ...
   procedure Derive_Master_Secret_384 (Master : out Digest_384; HS_Secret : in Digest_384);
   ...
   with
     Pre =>
       Finished_Key'First = 0
       and Finished_Key'Last = 47
       and Base_Secret'First = 0
       and Base_Secret'Last = 47;
   ...
   procedure Derive_PSK_384
     (PSK : out HKDF384.OKM384_Seq; Res_Master : in Byte_Seq; Nonce : in Byte_Seq)
   with
     Pre =>
       PSK'First = 0
       and PSK'Last = 47
       and Res_Master'First = 0
       and Res_Master'Last = 47
       and Nonce'First = 0
       and Nonce'Length > 0
       and Nonce'Length <= 255;

   procedure Derive_Binder_Key_384 (Binder_Key : out HKDF384.OKM384_Seq; PSK : in Bytes_48)
