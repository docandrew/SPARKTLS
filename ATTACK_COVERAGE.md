...
| Empty-record flood | closed | Empty encrypted application records are counted and capped (`Max_Empty_Records`); zero-length Alert or Handshake content is unexpected_message per RFC 8446 5.4 (2026-09-15). | `Empty_Records_Bounded_RFC_8446_5_2` predicate; tlsfuzzer `empty-alert`. |
